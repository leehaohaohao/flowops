...
## Phase 1: 后端 - 配置与新抽象（无破坏性变更）

### Step 1.1: application.yml 增加日志配置

**文件**: `flowops-app/src/main/resources/application.yml`
...
### Step 1.2: 创建 LogSource 接口

**新文件**: `flowops-app/src/main/java/com/nexa/flowops/service/log/LogSource.java`
...
### Step 1.3: 创建 LocalDockerLogSource 实现
