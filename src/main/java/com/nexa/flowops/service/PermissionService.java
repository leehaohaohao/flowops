...
public class PermissionService {
    ...
    public PermissionService(SysUserMapper userMapper,
                             ...
                             DeployServiceMapper deployServiceMapper,
    ...
    public boolean checkServicePermission(Long userId, Long serviceId, String requiredPerm) {
        ...
        Set<String> perms = getEffectivePermissions(userId, service.getProjectId());
    ...
    public List<Map<String, Object>> getUserGroups(Long userId) {
        ...
        for (GroupMember member : memberships) {
            ...
            // 用 mapper 查完整信息
            group = selectGroupById(member.getGroupId());
    ...
    private ProjectGroup selectGroupById(Long groupId) {
        return projectGroupMapper.selectById(groupId);
    }
}
